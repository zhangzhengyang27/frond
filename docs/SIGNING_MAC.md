...
| `com.apple.security.network.client` | 打包后仍有页面从公网拉资源：OCR worker 与语言包走 `cdn.jsdelivr.net` / `unpkg.com` / `tessdata.projectnaptha.com`（`screenshot.html:6-13` 的 CSP 与注释） | 中 |
